#### emotion mining ####
install.packages("syuzhet","lubridate","ggplot2","scales","dplyr","reshape2")
  library("syuzhet")
...
txt = readLines("/Volumes/Data/Course Content/DS content/Text Mining/Emotion Mining/amazon nokia lumia reviews.txt")
